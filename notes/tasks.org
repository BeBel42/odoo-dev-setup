...
* TODO [[https://www.odoo.com/odoo/project/1251/tasks/5477296][[Payroll][L10N_BE]End of year Bonus - Fond Horeca]]
...
*** TODO Regarder modalite d'octroi de la PFA pour voir si tu fais aussi pour ceux qui commencent apres janvier (genre ce serait 12% aussi?)
*** TODO Aussi ajouter ce truc de extra info si il est vire / demissionne (Termination Fees structure)
** TODOS
...
*** [ ] Create a similar rule in the end of contract structure (in case the contracts is ended we should pay part of the EOY bonus)
...
* DONE [[https://www.odoo.com/odoo/project/1251/tasks/5148888][[Work entries] Optimization/refactor of gantt view]]
#+begin_src bash :results silent
