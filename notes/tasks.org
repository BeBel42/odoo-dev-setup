...
** FIXME [[https://runbot.odoo.com/odoo/runbot.build.error/234174][Runbot build error]]
...
* TODO [[https://www.odoo.com/odoo/project/1251/tasks/4985543][[L10N_BE_Payroll] Changes since previous version]]
**master**
#+begin_src bash :results silent
../o --checkout-community master \
...
** [?]
I thought that users that could not see specific fields would be redirect to hr.employee.public (there is not chatter there).
