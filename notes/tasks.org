...
*** [ ] The amount of the PFA must impact the CSS rule (cotisation speciale à la securité social)
*** [ ] On monthly worker pay, a rule should be computed to make a provision to be paid to the horeca fund
**** [ ] This rule has no impact on employee salary --> put it with employer ONSS rules (at the end of the payslips, should not appear to employee on pdf)
**** [ ] Computed as 12% of the SALARY category (SALARY category = salary amount for which the employee has to pas ONSS taxes)
