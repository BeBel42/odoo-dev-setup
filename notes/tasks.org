...
* TODO [[https://www.odoo.com/odoo/my-tasks/4980966][[l10n_in_Payroll] Fix the basic rule calculation condition in the Python code]]
**18.0**
...
** TODO after unstuck:
*** [ ] l10n_in_basic_value is not actually the minimum wage but the minimum basic salary (will be at the right of the payroll form in the payroll tab). I will have to change all the comments / commits / variables saying it's a minimum wage
*** [ ] The constraint will have to be applied to all wage types. Not just monthly
*** [ ] The test will have to be changed accordingly
*** [ ] There will be a need for a migration (convert all old employees to have a basic salary of at least l10n_in_basic_value) (edited)
...
** DONE Check Runbot to fix issues (normally done otherwise)
