...
* FIXME [[https://www.odoo.com/odoo/my-tasks/5026228][[hr_holidays] Add back a well-formatted "Extra Hours" section in the Time Off dashboard]]
...
#+end_src
#+begin_src bash
./o -m hr_attendance,hr_holidays,hr_contract
#+end_src
...
** FIXME extra hours does not appear on the dashboard anymore...
** DONE add tests
